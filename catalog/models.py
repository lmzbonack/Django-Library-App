...
#used to calculate if books are overdue
...
class Language(models.Model):
    """
    Model representing the language of a specific book instances
    """
...
class Book(models.Model):
    """
    Model representing a book (not one specific copy of a book though)
    """
